...
def generate_items(conn):
    ...
    if not table_has_data(conn, "items"):
        items = [
            # Bearings (10)
            ("BR-6205", "Deep Groove Ball Bearing 6205", "Bearings", "pcs", 8.5, 12.75, 1, 18, 30),
            ("BR-6305", "Deep Groove Ball Bearing 6305", "Bearings", "pcs", 9.8, 12.75, 1, 18, 30),
            ("BR-6208", "Deep Groove Ball Bearing 6208", "Bearings", "pcs", 11.5, 16.1, 1, 18, 25),
            ("BR-32208", "Tapered Roller Bearing 32208", "Bearings", "pcs", 22.0, 26.4, 1, 20, 20),
            ("BR-6203", "Deep Groove Ball Bearing 6203", "Bearings", "pcs", 6.5, 9.75, 1, 16, 40),
            ("BR-6303", "Deep Groove Ball Bearing 6303", "Bearings", "pcs", 7.2, 9.36, 1, 16, 35),
            ("BR-6204", "Deep Groove Ball Bearing 6204", "Bearings", "pcs", 7.8, 11.7, 1, 17, 30),
            ("BR-6005", "Deep Groove Ball Bearing 6005", "Bearings", "pcs", 9.0, 10.8, 1, 18, 25),
            ("BR-6207", "Deep Groove Ball Bearing 6207", "Bearings", "pcs", 10.5, 14.7, 1, 19, 28),
            ("BR-6308", "Deep Groove Ball Bearing 6308", "Bearings", "pcs", 14.5, 17.4, 1, 20, 22),
            # Raw Materials (8)
            ...
            ("RM-Copper", "Copper Bar", "Raw Material", "kg", 12.5, 17.5, 1, 20, 25),
            # Castings & Forgings (6)
            ("CS-AL-450", "Aluminum Sand Casting (GH-450)", "Castings", "pcs", 45.0, 54.0, 1, 25, 20),
            ("CS-SS-150", "Stainless Steel Investment Casting", "Castings", "pcs", 68.0, 81.6, 1, 28, 15),
            ("FG-001", "Cast Iron Casting", "Castings", "pcs", 32.0, 41.6, 1, 22, 25),
            ("FG-002", "Steel Forging", "Forgings", "pcs", 28.0, 36.4, 1, 24, 18),
            ("CS-AL-150", "Aluminum Casting for Impeller", "Castings", "pcs", 38.0, 45.6, 1, 26, 20),
            ("FG-003", "Steel Forged Shaft Blank", "Forgings", "pcs", 42.0, 54.6, 1, 23, 22),
            ...
            # Seals & Gaskets (5)
            ("SL-35-52", "Oil Seal 35×52×7", "Seals", "pcs", 3.2, 3.6, 1, 15, 100),
            ("GS-450", "Cork + Rubber Gasket Set", "Seals", "set", 4.5, 4.9, 0, 10, 80),
            ("SL-17-30", "Mechanical Seal 17×30", "Seals", "pcs", 28.0, 34.2, 1, 22, 25),
            ("GS-150", "O-Ring Kit for Impeller", "Seals", "set", 2.8, 2.95, 0, 8, 120),
            ("SL-25-40", "Oil Seal 25×40×7", "Seals", "pcs", 2.5, 2.78, 1, 14, 90),
